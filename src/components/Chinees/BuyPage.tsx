            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <ThemeProvider theme={theme}>
                  <Typography variant="h3"  style={{fontSize: '1.8rem'}}>購買AIX代幣</Typography>
                </ThemeProvider>
                <ThemeProvider theme={theme}>
                  <Typography variant="subtitle1" style={{fontSize: '0.9rem', color:"rgba(0,0,0,0.4)"}}>使用USDT購買AIX代幣</Typography>
                </ThemeProvider>
                </Grid>
