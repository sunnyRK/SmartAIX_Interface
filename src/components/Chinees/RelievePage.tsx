...
const MainChinese: React.FunctionComponent = () => {
  ...
  return (
    ...
    <Container>
      <div>
        <Link className="back" to='/chinees' style={{margin:"10px 0px"}}>
          <img src={back}/>
        </Link>
          ...
          <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                <ThemeProvider theme={theme}>
                  <Typography variant="h3" style={{fontSize: '1.8rem'}}>解除質押AIX</Typography>
                </ThemeProvider>
                <ThemeProvider theme={theme}>
                  <Typography variant="subtitle1" style={{fontSize: '0.9rem', color:"rgba(0,0,0,0.4)"}}>解除質押AIX並且提取所獲得的AIXT</Typography>
                </ThemeProvider>
                </Grid>
