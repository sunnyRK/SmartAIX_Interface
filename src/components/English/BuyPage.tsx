            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <ThemeProvider theme={theme}>
                  <Typography variant="h3"  style={{fontSize: '1.8rem'}}>Marketplace of AIX token</Typography>
                </ThemeProvider>
                <ThemeProvider theme={theme}>
                  <Typography variant="subtitle1" style={{fontSize: '0.9rem', color:"rgba(0,0,0,0.4)"}}>Buy and Sell AIX token by depositing USDT and AIX token</Typography>
                </ThemeProvider>
                </Grid>
