        ...
        <Grid container spacing={3} >
          <Grid item xs={12}>
            <div className="checking-allowance">
              <ThemeProvider theme={theme}>
                <Typography variant="h3" style={{fontSize: '0.8rem', color: "#FFFFFF", textAlign: "center"}}>Claimable AIXT Reward</Typography>
              </ThemeProvider> 
            </div>
            <div className="checking-allowance">
              <ThemeProvider theme={theme}>
                <Typography variant="h5" style={{fontSize: '1rem', color:"rgba(255,255,255,0.4)", textAlign: "center", width:"100%",overflow:"hidden",textOverflow:"ellipsis", whiteSpace:"nowrap"}}>{parseFloat(claimableReward)/1e18} AIXT</Typography>
              </ThemeProvider>
            </div>
          </Grid>
          <Grid item xs={4}>
            <div className="checking-allowance" style={{marginTop:"5px"}}>
              <ThemeProvider theme={theme}>
                <Typography variant="h5" style={{fontSize: '0.9rem', color: "#FFFFFF", textAlign: "center",width:"100%",overflow:"hidden",textOverflow:"ellipsis", whiteSpace:"nowrap"}}>{parseFloat(userInfo[0])/1e18} AIX ({parseFloat(stackedStaticPercent)}%)</Typography>
              </ThemeProvider>
            </div>
            <div className="checking-allowance">
              <ThemeProvider theme={theme}>
                <Typography variant="h3" style={{fontSize: '1rem', color:"rgba(255,255,255,0.4)", textAlign: "center"}}>AIX Stacking</Typography>
              </ThemeProvider> 
            </div>
          </Grid>
          <Grid item xs={4}>
              <div className="checking-allowance" style={{marginTop:"5px"}}>
                <ThemeProvider theme={theme}>
                  <Typography variant="h5" style={{fontSize: '0.9rem', color: "#FFFFFF", textAlign: "center",width:"100%",overflow:"hidden",textOverflow:"ellipsis", whiteSpace:"nowrap"}}>{parseFloat(aixtBalance)/1e18} AIXT</Typography>
                </ThemeProvider>
              </div>
              <div className="checking-allowance">
                <ThemeProvider theme={theme}>
                  <Typography variant="h3" style={{fontSize: '1rem', color:"rgba(255,255,255,0.4)", textAlign: "center"}}>AIXT Balance</Typography>
                </ThemeProvider> 
              </div>
          </Grid>
          <Grid item xs={4}>
            <div className="checking-allowance" style={{marginTop:"5px"}}>
              <ThemeProvider theme={theme}>
                <Typography variant="h5" style={{fontSize: '0.9rem', color: "#FFFFFF", textAlign: "center",width:"100%",overflow:"hidden",textOverflow:"ellipsis", whiteSpace:"nowrap"}}>{parseFloat(aixBalance)/1e18} AIX</Typography>
              </ThemeProvider>
            </div>
            <div className="checking-allowance">
              <ThemeProvider theme={theme}>
                <Typography variant="h3" style={{fontSize: '1rem', color:"rgba(255,255,255,0.4)", textAlign: "center"}}>AIX Balance</Typography>
              </ThemeProvider> 
            </div>
          </Grid>
          <Grid item xs={4} spacing={0} style={{padding:'0px'}}>
            <div className="checking-allowance" style={{textAlign: "center",backgroundColor:"white",padding:'20px',borderTopLeftRadius:"10px",borderBottomLeftRadius:"10px"}}>
              <ThemeProvider theme={theme}>
                <Link to='/en/buy' style={{textDecoration:"none"}}>
                  <img src={goumai} style={{width:'45%', height:'45%'}}/>
                    <div className="txt" style={{color:"black", textDecoration:"none", whiteSpace:"nowrap"}}>Buy</div>
                </Link>
              </ThemeProvider>
            </div>
            </Grid>
            <Grid item xs={4} spacing={0} style={{padding:'0px',border:'none'}}>
              <div className="checking-allowance" style={{textAlign: "center",backgroundColor:"white",padding:'20px',marginLeft:"-1px",marginRight:"-1px"}}>
                <ThemeProvider theme={theme}>
                  <Link to='/en/pledge' style={{textDecoration:"none"}}>
                    <img src={jeichu} style={{width:'44%', height:'44%'}}/>
                    <div className="txt" style={{color:"black", textDecoration:"none", whiteSpace:"nowrap"}}>Deposit</div>
                  </Link>
                </ThemeProvider>
              </div>
            </Grid>
            <Grid item xs={4} style={{padding:'0px',border:'none'}}>
              <div className="checking-allowance" style={{textAlign: "center",padding:'20px', backgroundColor:"white",borderTopRightRadius:"10px",borderBottomRightRadius:"10px"}}>
                <ThemeProvider theme={theme}>
                  <Link to='/en/relieve' style={{textDecoration:"none"}}>
                    <img src={zhiya} style={{width:'45%', height:'45%'}}/>
                    <div className="txt" style={{color:"black", textDecoration:"none", whiteSpace:"nowrap"}}>Withdraw</div>
                  </Link>
                </ThemeProvider>
              </div>
            </Grid>
            <Grid item xs={6} style={{paddingLeft:"0px"}}>
              ...
              <div className="checking-allowance" style={{color:"rgba(0,0,0,1)", textAlign: "left"}}>
                <ThemeProvider theme={theme}>
                  <Typography variant="h5" style={{fontSize: '0.8rem', textAlign: "left",width:"100%",overflow:"hidden",textOverflow:"ellipsis", whiteSpace:"nowrap"}}><span style={{fontSize:"1rem"}}>{parseFloat(totalDeposit)/1e18}</span> AIX</Typography>
                </ThemeProvider>
              </div>
              ...
              <div className="checking-allowance" style={{borderRadius:"10px"}}>
                <ThemeProvider theme={theme}>
                  <Typography variant="inherit" style={{fontSize: '0.9rem', color:"rgba(0,0,0,0.4)", textAlign: "left", whiteSpace:"nowrap"}}>Total AIX Stacking</Typography>
                </ThemeProvider> 
              </div>
              </Paper>
            </Grid>
            <Grid item xs={6} style={{paddingRight:"0px"}}>
              <Paper className={classes.paper} style={{borderRadius:"10px"}}>
                <div className="checking-allowance" style={{color:"rgba(0,0,0,1)", textAlign: "left"}}>
                  <ThemeProvider theme={theme}>
                    <Typography variant="inherit" style={{fontSize: '0.8rem', display:"block", textAlign: "left",width:"100%",overflow:"hidden",textOverflow:"ellipsis", whiteSpace:"nowrap"}}>{parseFloat(userInfo[5])/1e18} AIX</Typography>
                    <Typography variant="inherit" style={{fontSize: '0.8rem', display:"block",textAlign: "left", width:"100%",overflow:"hidden",textOverflow:"ellipsis", whiteSpace:"nowrap"}}>{parseFloat(stackedTeamPercent)}%</Typography>
                  </ThemeProvider>
                </div>
                <div className="checking-allowance" style={{marginTop:"23px", textAlign: "left"}}>
                  <img className="icon" src={jiedian} width="20px" height="20px"/>
                </div>
                <div className="checking-allowance">
                  <ThemeProvider theme={theme}>
                    <Typography variant="inherit" style={{fontSize: '0.9rem', color:"rgba(0,0,0,0.4)", textAlign: "left", whiteSpace:"nowrap"}}>Team AIX Stacking</Typography>
                  </ThemeProvider> 
                </div>
              </Paper>
            </Grid>
            <Grid item xs={6} style={{backgroundColor:"#FFFFFF",padding:'10px 5px 10px 0px',borderTopLeftRadius:"10px",margin:"-1px"}}>
              <div className="checking-allowance">
                <ThemeProvider theme={theme}>
                  <Typography variant="inherit" style={{fontSize: '1rem', color:"rgba(0,0,0,0.4)", textAlign: "left", paddingLeft:"13px", whiteSpace:'nowrap'}}>Claimable Static AIXT Reward</Typography>
                </ThemeProvider> 
              </div>
          </Grid>
          ...
          <Grid item xs={6} style={{backgroundColor:"#FFFFFF",padding:'10px 5px 10px 0px',margin:"-1px"}}>
            <div className="checking-allowance">
                <ThemeProvider theme={theme}>
                  <Typography variant="inherit" style={{fontSize: '1rem', color:"rgba(0,0,0,0.4)", textAlign: "left", paddingLeft:"13px",margin:"-1px", whiteSpace:'nowrap'}}>Claimable Team AIXT Reward</Typography>
                </ThemeProvider> 
              </div>
          </Grid>
          <Grid item xs={4} style={{backgroundColor:"#FFFFFF",padding:'10px 5px 10px 0px',margin:"-1px"}}>
          ...
          <Grid item xs={6} style={{backgroundColor:"#FFFFFF",padding:'10px 5px 10px 0px',borderBottomLeftRadius:"10px", margin:"-1px",marginBottom:"30px"}}>   
              <div className="checking-allowance">
                <ThemeProvider theme={theme}>
                  <Typography variant="inherit" style={{fontSize: '1rem', color:"rgba(0,0,0,0.4)", textAlign: "left", paddingLeft:"13px", whiteSpace:'nowrap'}}>Claimable Invitor AIXT Reward</Typography>
                </ThemeProvider> 
              </div>
          </Grid>
